...
private getGroupName(id) {
    ...
    else if (id == '0e36095e-e5fd-4b6a-b72d-8185d7c31f85') {return 'Bathroom'}
    else if (id == '3155543b-5a3c-4a33-a8ee-d94d19b06f1f') {return 'Entrance'}
    else if (id == '55da535a-8380-41ef-a711-86b670483fa9') {return 'Kitchen'}
    else if (id == '585c59e5-291e-423a-87b5-c74da83e9d4e') {return 'Bedroom'}
    else if (id == '990dbd1b-d8c0-4676-8892-555a979cc4ac') {return 'Guest Bathroom'}
    else if (id == 'cbe1e61a-128b-4674-b223-41f8f5eafa44') {return 'Living Room'}
    else {return 'Unknown'}
}
