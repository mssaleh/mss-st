preferences {
	section("HASS Parameters"){
        ...
        input "hass_token", "text", title: "HA long-life token", required: true
	}
}

metadata {
	definition (name: "HASS URI Switch Token", namespace: "mssaleh", author: "Mohammed Saleh", vid: "generic-switch") {
			capability "Switch"
	}
