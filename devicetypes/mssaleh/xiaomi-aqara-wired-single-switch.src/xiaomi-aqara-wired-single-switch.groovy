// https://raw.githubusercontent.com/johndoyle/SmartThingsPersonal/master/devicetypes/johndoyle/xiaomi-mains-single-switch-no-neutral.src/xiaomi-mains-single-switch-no-neutral.groovy
metadata {
	definition (name: "Xiaomi Aqara Wired Single Switch", namespace: "mssaleh", author: "John Doyle", vid: "generic-switch") {
        capability "Actuator"
